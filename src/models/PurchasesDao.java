...
public class PurchasesDao {
    ...
    public boolean registerPurchaseDetailQuery(int purchase_id, double purchase_price, int purchase_amount, 
        ...
        String query = "INSERT INTO purchase_details (purchase_id, purchase price, purchase_amount,"
    ...
    public List listAllPurchasesQuery(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                purchase.setSupplier_name_product(rs.getString("setSupplier_name_product"));
                purchase.setTotal(rs.getDouble("total"));
                purchase.setCreted(rs.getString("created"));
    ...
    //METODO PARA LISTAR LAS COMPRAS PARA IMPRIMIR FACTURA
